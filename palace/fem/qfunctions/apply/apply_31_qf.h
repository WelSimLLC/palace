...
#ifndef PALACE_LIBCEED_APPLY_31_QF_H
#define PALACE_LIBCEED_APPLY_31_QF_H

CEED_QFUNCTION(f_apply_31)(void *, CeedInt Q, const CeedScalar *const *in,
                           CeedScalar *const *out)
{
  const CeedScalar *__restrict qd1 = in[0], *__restrict qd2 = in[0] + 9 * Q,
                                 *__restrict u1 = in[1], *__restrict u2 = in[2];
  CeedScalar *__restrict v1 = out[0], *__restrict v2 = out[1];

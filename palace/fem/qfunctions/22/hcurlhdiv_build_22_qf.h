...
#ifndef PALACE_LIBCEED_HCURL_HDIV_BUILD_22_QF_H
#define PALACE_LIBCEED_HCURL_HDIV_BUILD_22_QF_H

#include "../coeff/coeff_2_qf.h"
#include "utils_22_qf.h"

CEED_QFUNCTION(f_build_hcurlhdiv_22)(void *__restrict ctx, CeedInt Q,
...
CEED_QFUNCTION(f_build_hdivhcurl_22)(void *__restrict ctx, CeedInt Q,
                                     const CeedScalar *const *in, CeedScalar *const *out)
{
  const CeedScalar *attr = in[0], *wdetJ = in[0] + Q, *adjJt = in[0] + 2 * Q;
  CeedScalar *qd = out[0];

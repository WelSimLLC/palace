...
#ifndef PALACE_LIBCEED_L2_MASS_BUILD_22_QF_H
#define PALACE_LIBCEED_L2_MASS_BUILD_22_QF_H

#include "../coeff/coeff_1_qf.h"
#include "../coeff/coeff_2_qf.h"
#include "utils_22_qf.h"

CEED_QFUNCTION(f_build_l2mass_22)(void *__restrict ctx, CeedInt Q,
                                  const CeedScalar *const *in, CeedScalar *const *out)
{
  const CeedScalar *attr = in[0], *wdetJ = in[0] + Q, *adjJt = in[0] + 2 * Q, *qw = in[1];
  CeedScalar *__restrict qd1 = out[0], *__restrict qd2 = out[0] + 4 * Q;

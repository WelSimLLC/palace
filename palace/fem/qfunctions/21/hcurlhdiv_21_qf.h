...
#ifndef PALACE_LIBCEED_HCURL_HDIV_21_QF_H
#define PALACE_LIBCEED_HCURL_HDIV_21_QF_H

#include "../coeff/coeff_2_qf.h"
#include "utils_21_qf.h"

CEED_QFUNCTION(f_apply_hcurlhdiv_21)(void *__restrict ctx, CeedInt Q,
...
CEED_QFUNCTION(f_apply_hdivhcurl_21)(void *__restrict ctx, CeedInt Q,
                                     const CeedScalar *const *in, CeedScalar *const *out)
{
  const CeedScalar *attr = in[0], *wdetJ = in[0] + Q, *adjJt = in[0] + 2 * Q, *u = in[1];
  CeedScalar *v = out[0];
